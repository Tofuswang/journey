  ...
  return (
    <div className="bg-white rounded-lg shadow p-6 mb-6">
      ...
      <div className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-gray-800 mb-1">使用者行為</label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-800 mb-1">描述</label>
          <textarea
        ...
        <div>
          <label className="block text-sm font-medium text-gray-800 mb-1">系統/產品回應</label>
          <textarea
        ...
        <div>
          <label className="block text-sm font-medium text-gray-800 mb-1">痛點或改善機會</label>
          <textarea
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="col-span-2">
            <label className="block text-sm font-medium text-gray-800 mb-1">情緒描述</label>
            <input
              type="text"
